// app/products/saint-gobain/glass-wool/page.js
...
import { saintGobainData, getSaintGobainTypeBySlug as getTypeBySlug } from '../../data/dataService';
import styles from './styles.module.css';

export default function GlassWoolPage() {
    const typeData = getTypeBySlug('glass-wool');
    ...
    return (
        <>
            ...
            <main className={styles.glassWoolPage}>
                ...
                <div className={styles.productsGrid}>
                    {typeData.products.map((product) => (
                        <article key={product.id} className={styles.productCard}>
                            <Link
                                href={`/products/saint-gobain/glass-wool/${product.slug}`}
