        ...
        <>
            ...
            <main className={styles.productPage}>
                ...
                <nav className={styles.breadcrumb} aria-label="Breadcrumb">
                    ...
                    <span className={styles.breadcrumbArrow} aria-hidden="true">›</span>
                    <Link href="/products/saint-gobain/stone-wool" className={styles.breadcrumbLink}>
                        Stone Wool
                    </Link>
                    <span className={styles.breadcrumbArrow} aria-hidden="true">›</span>
                        ...
                        <div className={styles.relatedProductsGrid}>
                            {relatedProducts.map((relatedProduct) => (
                                <article key={relatedProduct.id} className={styles.relatedProductCard}>
                                    <Link href={`/products/saint-gobain/stone-wool/${relatedProduct.slug}`} className={styles.relatedProductLink}>
